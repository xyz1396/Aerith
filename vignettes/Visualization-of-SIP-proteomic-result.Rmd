...
```{r}
s <- summaryPSMsipPCT("../rmd/input data format/pct1.psm.txt", SIPthreshold = 0.5, chargeThreshold = 3)
knitr::kable(s)
s <- summaryPSMsipPCT("../rmd/input data format/pct50.psm.txt", SIPthreshold = 10, chargeThreshold = 3)
knitr::kable(s)
```
